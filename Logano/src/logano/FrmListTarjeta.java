 ...
 * FrmListTarjeta.java
 *
 * Created on 12/08/2011, 15:54:12
 */
 ...
 * @author loreh
 */
public class FrmListTarjeta extends javax.swing.JFrame {

    /** Creates new form FrmListTarjeta */
    public FrmListTarjeta() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(logano.LoganoApp.class).getContext().getResourceMap(FrmListTarjeta.class);
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmListTarjeta().setVisible(true);
            }
        });
    }
