 ...
 * FrmListGastos.java
 *
 * Created on 12/08/2011, 15:49:53
 */
 ...
 * @author loreh
 */
public class FrmListGastos extends javax.swing.JFrame {

    /** Creates new form FrmListGastos */
    public FrmListGastos() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(logano.LoganoApp.class).getContext().getResourceMap(FrmListGastos.class);
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmListGastos().setVisible(true);
            }
        });
    }
