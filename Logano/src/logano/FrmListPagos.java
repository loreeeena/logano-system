 ...
 * FrmListPagos.java
 *
 * Created on 12/08/2011, 15:50:43
 */
 ...
 * @author loreh
 */
public class FrmListPagos extends javax.swing.JFrame {

    /** Creates new form FrmListPagos */
    public FrmListPagos() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(logano.LoganoApp.class).getContext().getResourceMap(FrmListPagos.class);
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmListPagos().setVisible(true);
            }
        });
    }
