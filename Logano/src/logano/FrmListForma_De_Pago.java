...
/*
 * FrmListForma_De_Pago.java
 *
 * Created on 12/08/2011, 15:48:37
 */
 ...
 * @author loreh
 */
public class FrmListForma_De_Pago extends javax.swing.JFrame {

    /** Creates new form FrmListForma_De_Pago */
    public FrmListForma_De_Pago() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(logano.LoganoApp.class).getContext().getResourceMap(FrmListForma_De_Pago.class);
    ...
    private void btEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btEditarActionPerformed
        Frmforma_pago formap = new Frmforma_pago();
        Helper.showForm(formap);
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmListForma_De_Pago().setVisible(true);
            }
        });
    }
