 ...
 * FrmListUsuario.java
 *
 * Created on 12/08/2011, 15:55:16
 */
 ...
 * @author loreh
 */
public class FrmListUsuario extends javax.swing.JFrame {

    /** Creates new form FrmListUsuario */
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(logano.LoganoApp.class).getContext().getResourceMap(FrmListUsuario.class);
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmListUsuario().setVisible(true);
            }
        });
    }
