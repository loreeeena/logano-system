 ...
 * FrmListCliente.java
 *
 * Created on 12/08/2011, 15:43:24
 */
 ...
 * @author loreh
 */
public class FrmListCliente extends javax.swing.JFrame {

    /** Creates new form FrmListCliente */
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(logano.LoganoApp.class).getContext().getResourceMap(FrmListCliente.class);
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmListCliente().setVisible(true);
            }
        });
    }
