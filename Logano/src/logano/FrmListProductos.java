 ...
 *
 * Created on 12/08/2011, 15:51:29
 */
 ...
 * @author loreh
 */
public class FrmListProductos extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(logano.LoganoApp.class).getContext().getResourceMap(FrmListProductos.class);
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmListProductos().setVisible(true);
            }
        });
    }
