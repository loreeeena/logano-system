...
/*
 * FrmListFactura_Item.java
 *
 * Created on 12/08/2011, 15:47:24
 */
 ...
 * @author loreh
 */
public class FrmListFactura_Item extends javax.swing.JFrame {

    /** Creates new form FrmListFactura_Item */
    public FrmListFactura_Item() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(logano.LoganoApp.class).getContext().getResourceMap(FrmListFactura_Item.class);
    ...
    private void btEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btEditarActionPerformed
        Frmfactura_item facturai = new Frmfactura_item();
        Helper.showForm(facturai);
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmListFactura_Item().setVisible(true);
            }
        });
    }
