 ...
 * Frmtarjeta.java
 *
 * Created on 12/08/2011, 15:23:59
 */

package logano;

import loganosystem.contrato.Tarjeta;
import util.Helper;
 ...
 * @author loreh
 */
public class Frmtarjeta extends FrmBaseEdicion {
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(logano.LoganoApp.class).getContext().getResourceMap(Frmtarjeta.class);
    ...
    @Override
    protected Tarjeta getValues(){

         this.tarjeta.setNombre(tbnombre.getText());
         return this.tarjeta;
    }
    ...
    {
        this.tbnombre.setText(this.tarjeta.getNombre());
    }
