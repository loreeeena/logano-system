 ...
 * FrmListCheque.java
 *
 * Created on 12/08/2011, 15:40:21
 */
 ...
 * @author loreh
 */
public class FrmListCheque extends FrmBaseListado {

    /** Creates new form FrmListCheque */
    public FrmListCheque() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(logano.LoganoApp.class).getContext().getResourceMap(FrmListCheque.class);
    ...
    private void btEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btEditarActionPerformed
        Frmcheque cheque = new Frmcheque();
        Helper.showForm(cheque);
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmListCheque().setVisible(true);
            }
        });
    }
