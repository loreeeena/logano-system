...
/*
 * FrmListComprobante.java
 *
 * Created on 12/08/2011, 15:44:41
 */
 ...
 * @author loreh
 */
public class FrmListComprobante extends javax.swing.JFrame {

    /** Creates new form FrmListComprobante */
    public FrmListComprobante() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(logano.LoganoApp.class).getContext().getResourceMap(FrmListComprobante.class);
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmListComprobante().setVisible(true);
            }
        });
    }
