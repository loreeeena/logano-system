...
/*
 * FrmListProveedor.java
 *
 * Created on 12/08/2011, 15:52:25
 */
 ...
 * @author loreh
 */
public class FrmListProveedor extends javax.swing.JFrame {

    /** Creates new form FrmListProveedor */
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(logano.LoganoApp.class).getContext().getResourceMap(FrmListProveedor.class);
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmListProveedor().setVisible(true);
            }
        });
    }
