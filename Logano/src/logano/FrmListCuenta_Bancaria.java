...
/*
 * FrmListCuenta_Bancaria.java
 *
 * Created on 12/08/2011, 15:46:02
 */
 ...
 * @author loreh
 */
public class FrmListCuenta_Bancaria extends javax.swing.JFrame {

    /** Creates new form FrmListCuenta_Bancaria */
    public FrmListCuenta_Bancaria() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(logano.LoganoApp.class).getContext().getResourceMap(FrmListCuenta_Bancaria.class);
    ...
    private void btEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btEditarActionPerformed
        Frmcuenta_bancaria cuentab = new Frmcuenta_bancaria();
        Helper.showForm(cuentab);
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmListCuenta_Bancaria().setVisible(true);
            }
        });
    }
