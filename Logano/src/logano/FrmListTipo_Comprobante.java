...
/*
 * FrmListTipo_Comprobante.java
 *
 * Created on 12/08/2011, 15:55:03
 */
 ...
 * @author loreh
 */
public class FrmListTipo_Comprobante extends javax.swing.JFrame {

    /** Creates new form FrmListTipo_Comprobante */
    public FrmListTipo_Comprobante() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(logano.LoganoApp.class).getContext().getResourceMap(FrmListTipo_Comprobante.class);
    ...
    private void btEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btEditarActionPerformed
        Frmtipo_de_comprobante tipoc = new Frmtipo_de_comprobante();
        Helper.showForm(tipoc);
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmListTipo_Comprobante().setVisible(true);
            }
        });
    }
